...
<!-- BADGES -->
<p>
  <a href="#-sobre-este-experimento"><img src="https://img.shields.io/badge/Tipo-Experimento_Investigación-blueviolet?style=for-the-badge" alt="Tipo: Experimento"/></a>
  <a href="./manifesto.md"><img src="https://img.shields.io/badge/Ética-Académica_Neutral-green?style=for-the-badge" alt="Ética"/></a>
...
- ❌ Un producto terminado o token
- ❌ Consejo de inversión
- ❌ Afiliación política
- ❌ Una "respuesta" definitiva (la investigación está en curso)
...
- **Open Source**: Todos los hallazgos son públicos (MIT)
- **Académico**: Ejercicio teórico, no consejo de inversión
